      ...
      <div className="flex h-full min-h-[180px] flex-col justify-between gap-4 opacity-60">
        ...
        <div className="grid grid-cols-4 gap-1.5">
          {["D", "H", "M", "S"].map((label) => (
            <div
              key={label}
              className="rounded-xl border border-white/10 bg-black/20 px-1 py-2 text-center"
            >
              <div className="font-mono text-lg font-bold tabular-nums text-zinc-600 sm:text-xl">—</div>
